...
const ChattingModal = () => {
    const [openChattingImage, setOpenChattingImage] = useState("https://cdn.animaapp.com/projects/65741ad69db072ad359ef23b/releases/657951e5d664db7fd57b9dbd/img/chatting-icon.svg");
    ...
    const ChattingModalButtonClick = () => {
        ...
        if (openChattingModal) {
            setOpenChattingImage("https://cdn.animaapp.com/projects/65741ad69db072ad359ef23b/releases/657951e5d664db7fd57b9dbd/img/chatting-icon.svg");
            setCloseChattingImage(false);
        } else {
            setOpenChattingImage(false);
            setCloseChattingImage("https://cdn.animaapp.com/projects/65741ad69db072ad359ef23b/releases/657832b267a6ebed31481896/img/chatting-cancel-icon.svg");
        }
    };
        ...
        {openChattingModal && (
            <div className="chatting-modal">
                    ...
                    <div className="overlap-3">
                        ...
                        <div className="flexcontainer">
                            <p className="text-wrapper-3">
                                ...
                                <br /><br />
                                로그인 후 문의를 남겨주시면 더욱 빠르게 더움 드리도록 하겠습니다 !
                                <br /><br />
                ...
                <div className="chatting-input">
                    <div className="overlap-group">
                        ...
                        />
                        <input type='text' className="chatting-massage" placeholder='메세지를 입력해주세요.' />
                    </div>
                </div>
                ...
                <div className="overlap-group-wrapper">
                    <div className="overlap-5">
                        ...
                        <span className="text-wrapper-6">- Timezone: Asia/Seoul</span>
                        </p>
                        <img
            ...
            <button onClick={ChattingModalButtonClick}>
                <img
                    ...
                    className={openChattingModal ? 'chatting-cancel-icon' : 'chatting-icon'}
                />
                <img
                    src={closeChattingImage}
                    className={openChattingModal ? 'chatting-icon' : 'chatting-cancel-icon'}
                />
            </button>
        </div>
    </>
