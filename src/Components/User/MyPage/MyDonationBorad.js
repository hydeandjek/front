...
import '../../DonationBoard/Donation/scss/DonaDetail.scss';
import BoardList from '../../DonationBoard/List/BoardList';
import '../../DonationBoard/List/BoardList';
import { useHorizontalScroll } from '../../DonationBoard/UseSideScroll';
import { API_BASE_URL } from '../../../config/host-config';

const MyDonationBoard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/board/donation/all/mypage`, {
            headers: {
  ...
  return (
    <>
      <div id='donationBoard'>
        ...
        <div className='title_name_board' style={{left: '25.7%'}}>{myboard[1].name}</div>
...
export default MyDonationBoard;
