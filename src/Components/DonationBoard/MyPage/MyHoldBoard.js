...
const MyHoldBoard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/board/donation/mypage/HOLD`, {
            headers: {
  ...
  return (
    <>
      ...
      <div className='rec_center2' onMouseLeave={handleMouseLeave}>
        ...
        <div className='title_name_board' style={{left: '26.5%'}}>미승인 게시판</div>
